            ...
            <div class="recent-orders">
                <table id="tablax" border="0" cellspacing="5" cellpadding="5" class="table table-striped display responsive nowrap" style="width:100%" >   
                    <div class="container2" style="margin-top: 10px;padding: 5px">
                        <thead>
                            <tr>
                                <td> <p><font face="Arial" style="color: var(--color-info-dark); font-size: 1rem;">Nombre</font> </p></td> 
                                <td> <p><font face="Arial" style="color: var(--color-info-dark); font-size: 1rem;">Teléfono</font> </p></td> 
                                <td> <p><font face="Arial" style="color: var(--color-info-dark); font-size: 1rem;">Fecha</font> </p></td> 
                                <td> <p><font face="Arial" style="color: var(--color-info-dark); font-size: 1rem;">Hora</font> </p></td> 
                                <td> <p><font face="Arial" style="color: var(--color-info-dark); font-size: 1rem;">Mesa</font> </p></td> 
                                <td> <p><font face="Arial" style="color: var(--color-info-dark); font-size: 1rem;">Descripcion</font> </p></td>
                                ...
                                <td> <font face="Arial" style="color: var(--color-info-dark); font-size: 1rem;">Imprimir</font> </td>
                            </tr>
                        </thead>    
                    </div>
                    <tbody>
                        <?php foreach ($conexion -> query($datos) as $row) {
                            ?>  
                                <tr>
                                    ...
                                    <td><p><?php echo $row['Fecha_Reserva'] ?></p></td>
                                    <td><p><?php echo $row['Hora'] ?></p></td>  
                                    <td><p><?php echo $row['Mesa'] ?></p></td>  
                                    <td><p><?php echo $row['Descripcion'] ?></p></td>
                                    <td><a data-toggle="modal" data-target="#editarreserva<?php echo $row['Id_Reserva']; ?>"> <span class="material-icons-sharp" style="color: blue; cursor: pointer">edit</span> </a></td>     
                                    <td><a data-toggle="modal" data-target="#eliminarreserva<?php echo $row['Id_Reserva']; ?>"> <span class="material-icons-sharp" style="color: red; cursor: pointer;">delete</span> </a></td>   
                                    <td><a target="_blank" href="../Rreservas/reservas.php"><span class="material-icons-sharp">inventory</span></a></td>                               
                                </tr>
