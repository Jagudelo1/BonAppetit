                ...
                <div class="container2" style="margin-top: 10px;padding: 5px">
                    <thead>
                        <tr> 
                            ...
                            <td> <font face="Arial">Reportes</font> </td>    
                            <td> <font face="Arial">Gráficos</font> </td>    
                        </tr>
                    </thead>
                </div>
                <tbody>
                    ...
                    ?>      
                        <tr>
                            ...
                            <td><a href="anadir.php"> <span class="material-icons-sharp">add</span> </a></td>
                            <td><a target="_blank" href="../platillosr/index.php"> <span class="material-icons-sharp">inventory</span> </a></td>                              
                            <td><a target="_blank" href="../Grafico/index.php"> <span class="material-icons-sharp">analytics</span> </a></td>                              
                        </tr>
                    <?php
                    }
                    ?>
